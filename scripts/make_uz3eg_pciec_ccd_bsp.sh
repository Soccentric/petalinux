...
petalinux_project_configure_rootfs() {
  ...
  if [ -d ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/meta-user/uz3eg_pciec_ccd/recipes-apps ]; then
  ...
  if [ -d ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/meta-user/uz3eg_pciec_ccd/recipes-core ]; then
...
create_petalinux_bsp() {
  ...
  if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/config.${HDL_BOARD_NAME}_CCD.patch ]; then
    echo " "
    ...
    cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}
  elif [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/config.${HDL_PROJECT_NAME}.patch ]; then
    echo " "
