...
#                       Aug 11, 2018: 1.04 Updated for 2018.2 PetaLinux tools
#
# ----------------------------------------------------------------------------
...
petalinux_project_configure_devicetree() {
    ...
    if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/device-tree/system-user.dtsi.${HDL_PROJECT_NAME} ]; then
        echo " "
...
petalinux_project_configure_kernel() {
    ...
    if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/kernel/user.cfg.pz_fmc2 ]; then
...
create_petalinux_bsp() {
    ...
    if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/project/config.${HDL_BOARD_NAME}_sd_oob.patch ]; then
        echo " "
        echo "Patching PetaLinux project config ..."
        echo " "
        cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/configs/
        patch <${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/project/config.${HDL_BOARD_NAME}_sd_oob.patch
        cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}
    ...
    if [ "$BUILD_BOOT_QSPI_OPTION" == "yes" ]; then
        ...
        petalinux-package --boot --fsbl images/linux/${FSBL_PROJECT_NAME}.elf --fpga hw_platform/system_wrapper.bit --uboot --kernel --offset 0x660000 --force
