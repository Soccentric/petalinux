...
build_hw_platform() {
  ...
  if [ ! -e ${HDL_PROJECT_NAME}/${HDL_BOARD_NAME}/${HDL_PROJECT_NAME}.runs/impl_1/${HDL_PROJECT_NAME}_wrapper.sysdef ]; then
...
main_make_function() {
  ...
  PETALINUX_PROJECT_NAME=uz3eg_iocc_sd_oob_${PLNX_VER}
  PETALINUX_ROOTFS_NAME=uz3eg_iocc_sd_oob
  build_hw_platform
  create_petalinux_bsp
  ...
  PETALINUX_PROJECT_NAME=uz3eg_pciec_sd_oob_${PLNX_VER}
  PETALINUX_ROOTFS_NAME=uz3eg_pciec_sd_oob
  build_hw_platform
  create_petalinux_bsp
  ...
  PETALINUX_PROJECT_NAME=uz7ev_evcc_sd_oob_${PLNX_VER}
  PETALINUX_ROOTFS_NAME=uz7ev_evcc_sd_oob
  build_hw_platform
  create_petalinux_bsp
}
