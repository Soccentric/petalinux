...
petalinux_project_configure_devicetree() {
  ...
  if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/device-tree/system-user.dtsi.${HDL_BOARD_NAME} ]; then
    echo " "
...
petalinux_project_configure_kernel() {
  ...
  if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/kernel/user.cfg.${HDL_BOARD_NAME} ]; then
    ...
    if [ ! -d ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-kernel ]; then
      mkdir ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-kernel
    fi
    if [ ! -d ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-kernel/linux ]; then
      mkdir ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-kernel/linux
    fi
    if [ ! -d ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-kernel/linux/linux-xlnx ]; then
    ...
    if [ ! -f ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-kernel/linux/linux-xlnx_%.bbappend ]; then
...
petalinux_project_configure_rootfs() {
  ...
  if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/rootfs/config.${PETALINUX_ROOTFS_NAME} ]; then
    echo " "
  ...
  if [ -d ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/meta-user/${PETALINUX_ROOTFS_NAME} ]; then
  ...
  elif [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/rootfs/bbappend.${PETALINUX_ROOTFS_NAME} ]; then
    echo " "
...
petalinux_project_set_boot_config_qspi() {
  ...
  echo " "
  cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-bsp/u-boot/files/
  cp -rf ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/u-boot/platform-top.h.ultra96v1_qspi_boot ./platform-top.h
  cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}
}
...
petalinux_project_set_boot_config_emmc() {
  ...
  echo " "
  cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-bsp/u-boot/files/
  cp -rf ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/u-boot/platform-top.h.ultra96v1_emmc_boot ./platform-top.h
  cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}
}
...
petalinux_project_set_boot_config_emmc_no_bit() {
  ...
  echo " "
  cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-bsp/u-boot/files/
  cp -rf ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/u-boot/platform-top.h.ultra96v1_emmc_boot_no_bit ./platform-top.h
  cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}
}
...
petalinux_project_set_boot_config_sd_no_bit() {
  ...
  echo " "
  cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/meta-user/recipes-bsp/u-boot/files/
  cp -rf ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/u-boot/platform-top.h.ultra96v1_sd_boot_no_bit ./platform-top.h
  cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}
}
...
petalinux_project_set_boot_config_sd() {
  ...
  cp -rf ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/u-boot/bsp.cfg ./bsp.cfg
  #  cp -rf ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/u-boot/u-boot-xlnx_%.bbappend
...
petalinux_project_set_boot_config_sd_ext4() {
  ...
  echo " "
  cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/project-spec/configs
  patch <${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/project/config.sd_ext4_boot.patch
  cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}
...
create_petalinux_bsp() {
  ...
  if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/project/config.${HDL_BOARD_NAME}.patch ]; then
    echo " "
  ...
  elif [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/project/config.${HDL_BOARD_NAME} ]; then
    echo " "
  ...
  if [ "$BUILD_BOOT_QSPI_OPTION" == "yes" ]; then
    ...
    while [ $PLNX_BUILD_SUCCESS -ne 0 ]; do
  ...
  if [ "$BUILD_BOOT_EMMC_OPTION" == "yes" ]; then
    # Restore project configurations and wipe out any changes made for special boot options.
    petalinux_project_restore_boot_config
  ...
  if [ "$BUILD_BOOT_EMMC_NO_BIT_OPTION" == "yes" ]; then
    # Restore project configurations and wipe out any changes made for special boot options.
    petalinux_project_restore_boot_config
  ...
  if [ "$BUILD_BOOT_SD_NO_BIT_OPTION" == "yes" ]; then
    # Restore project configurations and wipe out any changes made for special boot options.
    petalinux_project_restore_boot_config
  ...
  if [ "$BUILD_BOOT_SD_OPTION" == "yes" ]; then
    # Restore project configurations and wipe out any changes made for special boot options.
    petalinux_project_restore_boot_config
    ...
    # of the SOMs.
    if [ "$BUILD_BOOT_SD_OOB_OPTION" == "yes" ]; then
      # Create boot image which does not contain the bistream image.
      petalinux-package --boot --fsbl images/linux/${FSBL_PROJECT_NAME}.elf --uboot --force
    ...
    # Copy the image.ub file and name the new file image_SD.ub
    cp ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/images/linux/image.ub \
      ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/image_SD.ub
  fi

  # If the SD boot option is set, then perform the steps needed to
  # build BOOT.BIN for booting from SD with the bistream loaded from
  # the BOOT.BIN container image on the SD card.
  if [ "$BUILD_BOOT_SD_EXT4_OPTION" == "yes" ]; then
    # Restore project configurations and wipe out any changes made for special boot options.
    petalinux_project_restore_boot_config
    ...
    if [ "$BUILD_BOOT_SD_OOB_OPTION" == "yes" ]; then
      ...
      # Copy the boot.bin file and name the new file BOOT_SD_EXT4_OOB.BIN
      cp ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/images/linux/BOOT.BIN \
        ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/BOOT_SD_EXT4_OOB.bin
    fi
    ...
    # Copy the image.ub file and name the new file image_SD_EXT4.ub
    cp ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/images/linux/image.ub \
      ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/image_SD_EXT4.ub
  fi
...
build_hw_platform() {
  ...
  if [ ! -e ${HDL_PROJECT_NAME}/${HDL_BOARD_NAME}_${PLNX_VER}/${HDL_PROJECT_NAME}.runs/impl_1/${HDL_PROJECT_NAME}_wrapper.sysdef ]; then
...
main_make_function() {
  ...
  PETALINUX_ROOTFS_NAME=ultra96v1_full
  build_hw_platform
  create_petalinux_bsp
}
