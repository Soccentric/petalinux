...
create_petalinux_bsp() {
  ...
  #TC  cp -f ${HDL_PROJECT_NAME}/${HDL_BOARD_NAME}_${PLNX_VER}/${HDL_BOARD_NAME}.runs/impl_1/${HDL_BOARD_NAME}_wrapper.sysdef \
  #TC  ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/hw_platform/${HDL_HARDWARE_NAME}.hdf
  ...
  #read -t 10 -p "Pause here for 10 seconds"
    ...
    [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/project/config.${HDL_BOARD_NAME} ]
  then
    echo " "
...
build_hw_platform() {
  ...
  if [ ! -e ${HDL_PROJECT_NAME}/${HDL_BOARD_NAME}_${PLNX_VER}/${HDL_BOARD_NAME}.runs/impl_1/${HDL_BOARD_NAME}_wrapper.sysdef ]; then
    ...
    echo "No built Vivado HW project ${HDL_BOARD_NAME}/${HDL_BOARD_NAME}_${PLNX_VER} found."
