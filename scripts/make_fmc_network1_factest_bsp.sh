...
petalinux_project_configure_rootfs() {
  ...
  if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/rootfs/config.fmc_network1_factest ]; then
    echo " "
  ...
  if [ -d ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/meta-user.fmc_network1_factest/recipes-apps ]; then
  ...
  if [ -d ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/meta-user.fmc_network1_factest/recipes-core ]; then
...
create_petalinux_bsp() {
  ...
  if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/project/config.fmc_network1_factest.patch ]; then
    echo " "
    ...
    patch <${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/project/config.fmc_network1_factest.patch
    cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}
  elif [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/project/config.${HDL_PROJECT_NAME}.patch ]; then
    echo " "
