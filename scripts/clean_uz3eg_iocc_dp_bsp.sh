...
#  Module Name:         clean_uz3eg_iocc_dp_bsp.tcl
...
#                       carriers such as the IOCC (UZ3EG_IOCC)
#
...
HDL_HARDWARE_NAME=uz3eg_iocc_dp_hw
HDL_PROJECT_NAME=uz3eg_iocc_dp
...
main_clean_function() {
  ...
  PETALINUX_PROJECT_NAME=uz3eg_iocc_dp_2017_2
  clean_petalinux_bsp
