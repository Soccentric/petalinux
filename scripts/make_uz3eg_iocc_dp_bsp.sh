...
#  Module Name:         make_uz3eg_iocc_dp_bsp.tcl
...
petalinux_project_configure_kernel() {
  ...
  if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/kernel/user.cfg.${HDL_PROJECT_NAME} ]; then
...
petalinux_project_configure_rootfs() {
  ...
  if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/rootfs/config.${HDL_PROJECT_NAME} ]; then
    echo " "
  ...
  if [ -d ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/meta-user/${HDL_PROJECT_NAME}/recipes-apps ]; then
  ...
  if [ -d ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/meta-user/${HDL_PROJECT_NAME}/recipes-core ]; then
  ...
  if [ -d ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/meta-user/${HDL_PROJECT_NAME}/recipes-graphics ]; then
    ...
    echo " "
    echo "WARNING: No graphics files found, "
    echo "project-spec/meta-user/recipes-graphics is not touched for this build ..."
    echo " "
  fi
}
...
create_petalinux_bsp() {
  ...
  if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/project/config.${HDL_PROJECT_NAME}.patch ]; then
    echo " "
    ...
    cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}
  elif [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/project/config.${PETALINUX_PROJECT_NAME} ]; then
    echo " "
