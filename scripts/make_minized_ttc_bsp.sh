...
#  Module Name:         make_minized_ttc_bsp.sh
...
#
#  Description:         Build Script for MiniZed PetaLinux BSP
#
#  Dependencies:        None
#
...
HDL_HARDWARE_NAME=minized_ttc_hw
HDL_PROJECT_NAME=minized_ttc
...
create_petalinux_bsp() {
  ...
  if [ "$BUILD_BOOT_QSPI_OPTION" == "yes" ]; then
    ...
    petalinux-package --boot --fsbl images/linux/${FSBL_PROJECT_NAME}.elf --fpga ./images/linux/system.bit --uboot --kernel --offset 0x660000 --force
...
main_make_function() {
  ...
  PETALINUX_PROJECT_NAME=minized_ttc_${PLNX_VER}
  PETALINUX_ROOTFS_NAME=minized_ttc
  build_hw_platform
  create_petalinux_bsp
